...
import { DENOMINATION_OPTIONS } from "@/lib/denominationContent";
...
export function TheologicalPreferencesCard({ stats, userId, onUpdate }: TheologicalPreferencesCardProps) {
        ...
        {denominationSaved && (
          <Alert className="bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-800">
            ...
            <AlertDescription className="text-green-700 dark:text-green-300">
              Your theological preference has been updated. Parrot will now respond according to your tradition&apos;s
              distinctives.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              This helps Parrot tailor responses to your tradition&apos;s secondary doctrines (baptism, church
              governance, spiritual gifts, etc.). All responses remain anchored in the essentials we hold in common.
            </p>
          </div>
          ...
          <Button
            ...
            disabled={selectedDenomination === (stats?.denomination || "reformed-baptist") || isSavingDenomination}
