...
* **Confessional Reformed (Encouraged):** The church publicly subscribes to a historic Reformed confession (for example, the Westminster Standards, the 1689 London Baptist Confession, or the Three Forms of Unity).
* **Recommended:** Based on what is published, the church affirms the essential Christian doctrines.
* **Limited Information:** The website does not clearly state several essentials. We encourage reaching out to the church for clarification.
* **Not Endorsed:** Based on what is published, the church denies one or more essential doctrines or presents clear red flags.
