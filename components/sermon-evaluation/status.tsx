...
const STAGE_COPY: Partial<Record<SermonStatus, string>> = {
  ...
  HARMONIZING: "Combining independent scores and coaching feedback",
  AGGREGATING: "Computing rubric aggregates and policy gates",
  SUMMARIZING: "Creating coaching feedback and versioned reports",
  COMPLETE: "Coaching feedback is ready",
  COMPLETE_WITH_WARNINGS: "Coaching feedback is ready with fewer completed runs",
